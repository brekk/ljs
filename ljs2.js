...
function flatSpread(func, start) {
  return function() {
    ...
    var length = arguments.length,
        ...
        args = Array(length);
    while (length--) {
      args[length] = arguments$1[length];
    }
...
function baseConvert(util, name, func, options) {
  ...
  function cloneByPath(object, path$$1) {
...
var func = convert_1('forEach', forEach_1);
...
var func$3 = convert_1('curry', curry_1);
...
var func$4 = convert_1('filter', filter_1);
func$4.placeholder = placeholder;
var filter$1 = func$4;

var range = curry$1(function _range(fromStart, toEnd, comment) {
...
var addWhitespace = curry$1(function _addWhitespace(
  raw,
  syntax,
  tokens,
  fromStart,
  ...
  var ws;
  var commentFilter = filter$1(range(fromStart, toEnd));
  var comments = commentFilter(syntax.comments);
  forEach$1(function _processComment(c) {
...
var lex = curry$1(function _lex(options, raw) {
...
var note = curry$1(function (x, fn) { return fn; });
var isWhitespace = note("isWhitespace")(function (x) { return regex.whitespaceEnd.test(x); }
);
var stripShebang = note("stripShebang")(function _stripShebang(x) {
  var match = x.match(regex.shebang);
  return match ? x.substr(match[0].length) : x
});

var fileDirective = note("fileDirective")(function _fileDirective(
  filename,
  value,
  comparison,
  callback
...
var commentHasMagicIndicator = note("commentHasMagicIndicator")(
...
var getTokens = note("getTokens")(function _getTokens(filename) {
  ...
  forEach$1(
    note("processToken")(function _processToken(t) {
      ...
      if (commentHasMagicIndicator(t)) {
        var value = t.value.value.substr(magicIndicator.length + 1);
        r = fileDirective(
          filename,
          value,
          regex.plain,
      ...
      } else if (regex.ignore.test(t.value.value)) ; else {
...
var unindent = note("unindent")(function _unindent(value) {
  var lines = value.split(regex.newline);
  var first = find$1(function (l) { return !isWhitespace(l); }, lines);
  var indent = first ? regex.whitespace.exec(first)[1] : EMPTY;
...
var literate = note("function")(function _literate(
  filename,
  opts
) {
  if ( opts === void 0 ) opts = {};
  var code = opts.code || false;
  var codeOpen = opts.codeOpen || codeFenceOpen;
  var codeClose = opts.codeClose || codeFenceClose;
...
var ljs2 = function () {
  ...
  return cli.map(function (program) {
    ...
    var noMeld = program["no-meld"];
    var noCode = program["no-code"];
    var filename = program.input;
...
ljs2().fork(console.error, console.log);
